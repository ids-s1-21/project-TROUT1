...
## Correlation between Area and Price over the Further Outer region

```{r data for housetype, echo = FALSE, warning = FALSE, message=FALSE}
London %>%
  filter(large_region == "Further Outer") %>%
ggplot(aes(x = `Area in sq ft`, y = Price)) +
  geom_point() +
  geom_smooth(method = "lm", color = "blue", se = FALSE) +
...
## Table showing correlation between Area and Price over the Further Outer region
