...
3. Extract the District Code in the "Postal Code" variable.^3^
...
3. District Code is always the first two to four characters in postal code. i.e: SW9X 9BT has District Code of SW9. This always indicates which region does the house locate.
...
- There is no obvious difference in the histogram
