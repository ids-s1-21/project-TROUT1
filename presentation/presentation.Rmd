...
<font size = '6'>- We are curious about if there is a region in "Further Outer" has a very high housing price per sq ft that is affecting our result. So we made a map to see the distribution of housing price.</font>
...
- It seems that there is no such region exsists. The housing price per sq ft in "Further outer" is higher than "Outer" region in general.
