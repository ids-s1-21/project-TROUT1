...
ggplot(aes(x = `Area in sq ft`, y = Price)) +
  geom_point() +
  geom_smooth(method = "lm", color = "blue", se = FALSE) +
  labs(title = "Linear model of Area against Price in the Further Outer region") +
  scale_y_continuous(labels = label_dollar(scale = 0.000001, suffix = "M"))
...
```
The increase in adjusted r squared from 0.574 to 0.730 shows that limiting the data to 1 large region makes the strength of the correlation between area and price much higher.
