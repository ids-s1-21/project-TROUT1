...
In this project we will explore how factors such as:
...
The dataset we used was obtained from Kaggle. According
...
As you can see, a major issue with our dataset
...
![Dviding rule image](presentation/presentation_files/Support-files/London_Region_divide.png)
...
We are curious if there is an outlier region in "Further Outer" that has a higher housing price per sq ft than the "Outer" region which is skewing our result. So we made a map to see the distribution of housing prices.
